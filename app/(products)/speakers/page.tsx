    ...
    <>
      ...
      <div className="mb-[7.5rem] ">
        ...
        {SpeakersPage.map((product) => (
          <div
            key={product.name}
            className="flex flex-wrap odd:my-32 px-6 xl:flex-row lg:flex-nowrap xl:even:flex-row-reverse xl:px-32 2xl:px-80 lg:mt-16 xl:h-[560px] xl:gap-32 2xl:gap-60 "
          >
            <ProductContainer
              name={product.name}
              type={product.type}
