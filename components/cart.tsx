        ...
        <>
            {cartIsOpen && (
                <motion.div
                    ...
                    className="absolute z-[999] m-6 rounded-lg left-0 right-0 px-7 py-9 bg-white shadow-lg flex flex-col justify-center md:w-[500px] md:left-[30%] 2xl:w-[500px] 2xl:left-[52%] 2xl:top-40"
                >
                    {" "}
                    <IoIosClose
                                ...
                                return (
                                    <div key={item.name}>
                                        <div className="flex justify-between items-center h-full my-4">
                                            ...
                                            <div
                                                className="flex items-center bg-light-gray/10 text-center justify-between w-1/4  uppercase text-sm font-semibold tracking-widest ">
                                                <button
                                                    onClick={() => {
                                                        removeItem(item);
                                                    }}
