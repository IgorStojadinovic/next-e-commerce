...
import {DispatchItem, IndividualProduct} from "@/lib/types";
    ...
    return (
        <>
            ...
            <div className="2xl:px-80  md:px-24 px-6">
                ...
                {/** */}
                <section
                    className="flex flex-col justify-center items-center md:flex-row md:gap-5 lg:flex-row 2xl:gap-32 2xl:justify-center 2xl:items-center lg:gap-28 xl:gap-36">
            ...
            <span className="text-orange  uppercase tracking-[0.5rem] ">
              {type}
                        ...
                        <div className="flex justify-between gap-4">
                            <div
                                className="flex items-center bg-light-gray/10 text-center justify-between  w-full uppercase text-sm font-semibold tracking-widest">
                                <button
                                    onClick={() => {
                                        dispatch(decrement());
                                    }}
                            ...
                            <button
                                ...
                                className="bg-btn-orange text-white w-full p-4  uppercase text-sm font-semibold tracking-widest hover:bg-white border border-orange border-1 hover:text-orange transition-all duration-300"
                            >
                                Add to cart
                            </button>
                        </div>
                        ...
                        <div className="2xl:flex items-center gap-4 mb-32">
                            {products.map((item) => (
                                ...
                                >
                                    ...
                                    <Link
                                        href={item.link}
                                        className="bg-btn-orange p-4 w-1/2 text-white text-center uppercase text-sm font-semibold tracking-widest hover:bg-white border border-orange border-1 hover:text-orange transition-all duration-300 "
                                    >
                                        See product
                                    </Link>
                                </div>
